      ...
      <div className="container relative z-10 px-4 py-12 md:py-24 mx-auto w-full max-w-7xl flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-white/60 font-light leading-relaxed max-w-xl mx-auto lg:mx-0">
            Register now for a chance to win a custom Tesla Model S. Zero emissions. Zero compromises. Pure performance.
          </p>
          
          <div className="mt-12 flex items-center justify-center lg:justify-start gap-8 border-t border-white/10 pt-8">
            <div>
              <div className="text-3xl font-display font-bold text-white">1.99s</div>
              <div className="text-xs font-display tracking-widest text-white/40 uppercase mt-1">0-60 mph</div>
            </div>
            <div className="w-px h-12 bg-white/10" />
            <div>
              <div className="text-3xl font-display font-bold text-white">396mi</div>
              <div className="text-xs font-display tracking-widest text-white/40 uppercase mt-1">Range</div>
            </div>
            <div className="w-px h-12 bg-white/10 hidden sm:block" />
            <div className="hidden sm:block">
              <div className="text-3xl font-display font-bold text-white">200mph</div>
              <div className="text-xs font-display tracking-widest text-white/40 uppercase mt-1">Top Speed</div>
            </div>
          </div>
        </motion.div>
